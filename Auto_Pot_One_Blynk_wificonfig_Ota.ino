...
char blynk_token[34] = "9Dr8hUbxIRQo6oeBN_lP61bmARzgjhqS"; // {"vqmXhqzPZVclHkQwJRUWHVJPQzZhDe8Z" sam_si..tfr10sj1 Do not use it!!!},aram = "9Dr8hUbxIRQo6oeBN_lP61bmARzgjhqS";, Sam = "7OglfGHWHXIPi-y-rHGDcjMANgIsncR1";

bool shouldSaveConfig = false; //flag for saving data
int enA = 15; //enable pin in l298n
int motorPin = 0; // for mini D1 = 5, Nodemcu = 14, ESP_01 = 0;
...
{
  //toggle state
  int state = digitalRead(1);  // get the current state of GPIO1 pin  // for ESP-01 the led input is 1
  digitalWrite(1, !state);     // set pin to the opposite state // for ESP-01 the led input is 1
}
...
void setup()
{
  ...
  pinMode(1, OUTPUT); // for ESP-01 the led input is 1
  pinMode(enA, OUTPUT);
  ...
  ticker.detach();
  //turn LED off
  digitalWrite(1, HIGH);// for ESP-01 the led input is 1
