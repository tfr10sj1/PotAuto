...
void handleRoot()
{
  server.send(200, "text/html",
              ...
              "<input type=\"text\" name=\"Delayv\" placeholder=\"Plant1_Defualt = 1500 ms \">"
              "<input type=\"text\" name=\"Delayh\" placeholder=\"Plant2_Defualt = 1500 ms \">"
              "<input type=\"text\" name=\"Delayh\" placeholder=\"Plant3_Defualt = 1500 ms \">"
              "<input type=\"text\" name=\"Delayh\" placeholder=\"Plant4_Defualt = 1500 ms \">"
              "<input type=\"submit\" value=\"Send Command\">"
              "</form>"
...
void handleNotFound() {
  ...
  if (!server.hasArg("Counter") && server.arg("Plant1") != "")
  {
    Plant1 = server.arg("Plant1");
  }
  if (!server.hasArg("Counter") && server.arg("Plant2") != "")
  {
    Plant2 = server.arg("Plant2");
  }
  if (!server.hasArg("Counter") && server.arg("Plant3") != "")
  {
    Plant3 = server.arg("Plant3");
  }
  if (!server.hasArg("Counter") && server.arg("Plant4") != "")
  {
    Plant4 = server.arg("Plant4");
  }
  handleserver();
}
...
void handleserver()
{
  ...
  server.send(200, "text/html",
              ...
              "<h2>" 
                ...
                "<input type=\"text\" name=\"counter\" placeholder=\"Start every N hours \">"
                "<input type=\"text\" name=\"Plant1\" placeholder=\"Plant1_Defualt = 1500 ms \">"
                "<input type=\"text\" name=\"Plant2\" placeholder=\"Plant2_Defualt = 1500 ms \">"
                 "<input type=\"text\" name=\"Plant3\" placeholder=\"Plant3_Defualt = 1500 ms \">"
                "<input type=\"text\" name=\"Plant4\" placeholder=\"Plant4_Defualt = 1500 ms \">"
                "<input type=\"submit\" value=\"Send Command\">"
                "</form>"
              "</h2>"
              "</li>"
              ...
              "</ul>"
              "<ul>"
              "<li>Plant1 is: " + Plant1 + "</li>"
              "<li>Plant2 is: " + Plant2 + "</li>"
              "<li>Plant3 is: " + Plant3 + "</li>"
              "<li>Plant4 is: " + Plant4 + "</li>"
              "</ul>"
              "</nav>"
              "</section>"
              "<article>"
...
void NextTime()
{
  ...
  if (tot <= 24)
  {
    ...
    if (newHour != "24" && newHour.length() == 1) {
      newHour = ('0' + newHour);
    }
    Hours = newHour;
    Minutes = newMinute;
